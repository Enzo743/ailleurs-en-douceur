...
export const metadata: Metadata = {
  title: "Mes offres en douceur - Ailleurs en Douceur",
  description: "Découvrez nos offres de voyage sur mesure : Impulsion Douce, Échappée Douce et Lune de Douceurs",
};
...
export default async function OffersPage() {
  ...
  const offers = [
    {
      id: "impulsion-douce",
      title: c['offers/offer1-title'],
      subtitle: c['offers/offer1-subtitle'],
      description: c['offers/offer1-description'],
      image: c['offers/offer1-image'],
      icon: <FeatherIcon />,
    },
    {
      id: "echappee-douce",
      title: c['offers/offer2-title'],
      subtitle: c['offers/offer2-subtitle'],
      description: c['offers/offer2-description'],
      image: c['offers/offer2-image'],
      icon: <MapIcon />,
    },
    {
      id: "lune-douceur",
  ...
  const steps = [
    {
      number: "01",
      title: c['offers/step1-title'],
      description: c['offers/step1-description'],
    },
    {
      number: "02",
      title: c['offers/step2-title'],
      description: c['offers/step2-description'],
    },
    {
      number: "03",
      title: c['offers/step3-title'],
      description: c['offers/step3-description'],
    },
    {
      number: "04",
      title: c['offers/step4-title'],
      description: c['offers/step4-description'],
    },
  ];
  ...
  return (
    <div className={styles.offersPage}>
      {/* Header */}
      <Header currentPage="/offers" siteContent={c} />

      {/* Hero Section */}
      <section 
        className={styles.heroSection}
        style={{
          backgroundImage: `url(${c['offers/hero-image']})`,
        }}
      >
        <div className={styles.heroContent}>
          <h1 className={styles.heroTitle}>{c['offers/hero-title']}</h1>
          <p className={styles.heroSubtitle}>{c['offers/hero-subtitle']}</p>
      ...
      <section className={styles.introSection}>
        <div className={styles.container}>
          <div className={styles.introContent}>
            <p className={styles.introTagline}>{c['offers/intro-tagline']}</p>
            <RichTextDisplay 
              html={c['offers/intro-title']}
      ...
      {/* Offers Grid Section */}
      <section className={styles.offersGridSection}>
        <div className={styles.container}>
            ...
            {offers.map((offer, index) => (
              <article key={offer.id} className={styles.offerCard}>
                ...
                <div className={styles.offerCardImageContainer}>
                  ...
                  />
                  <div className={styles.offerCardImageOverlay} />
                </div>

                {/* Ellipse */}
                <div className={styles.offerCardEllipse} />
                ...
                <div className={styles.offerCardContent}>
                  ...
                  <p className={styles.offerCardSubtitle}>{offer.subtitle}</p>
                  <p className={styles.offerCardDescription}>{offer.description}</p>
                  <Link href={`/offers/${offer.id}`} className={styles.offerCardLink}>
                    {c['offers/cta-text'] || "En savoir plus"}
                    <ArrowRightIcon />
                  </Link>
                </div>
              </article>
      ...
      <section className={styles.howItWorksSection}>
        <div className={styles.container}>
          <h2 className={styles.howItWorksTitle}>{c['offers/how-it-works-title']}</h2>
            ...
            {steps.flatMap((step, index) => [
              ...
              index < steps.length - 1 && (
                <div 
                  ...
                  className={`${styles.stepConnector} ${index === steps.length - 2 ? styles.stepConnectorLast : ''}`}
                />
              )
            ]).filter(Boolean)}
          </div>
